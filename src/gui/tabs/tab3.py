...
from ._tab3.subtab1 import Sub1Tab3Button
from ._tab3.subtab2 import Sub2Tab3Button
...
class Tab3(QWidget):
    ...
    def init_ui(self):
        ...
        self.main_button = QPushButton("Сигналы во временной области")
        self.main_button.setStyleSheet(tab)
        self.main_button.setCheckable(True)
        self.main_button.clicked.connect(self.toggle_subtabs)

        self.subtab1 = Sub1Tab3Button(4, self.main_window, self.main_tab_id)
        self.subtab2 = Sub2Tab3Button(5, self.main_window, self.main_tab_id)
